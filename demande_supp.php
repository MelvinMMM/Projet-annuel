...
<?php 
	...
	// var_dump($results);
?>
<h1 class="text-center text-light mt-3 mb-3"> Voulez-vous vraiment suprimer le joueur ?</h1>
    <table class="table table-dark table-striped">
				  ...
				  <tbody>
				  	...
				  	foreach ($results as $joueurs) {
						...
						echo '<td>';
                        echo '<a class="btn btn-sm btn-danger me-2" href="verif_supp.php?id=' . $joueurs['id'] . '"> Oui ! </a>';
