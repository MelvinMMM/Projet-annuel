<header>
    ...
    <h1 class="text-center">NOM DU SITE</h1>
        ...
        <nav class="navbar navbar-expand-lg navbar-light justify-content-around">
            ...
            <a class="navbar-brand ms-5" href="Accueil.php">Home</a>
            ...
            <a class="navbar-brand ms-5" href="Accueil.php">Jeux</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>

              <!-- <li class="navbar-brand dropdown">
                <a class="align-items-center nav-link dropdown-toggle ms-5" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Jeux 
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="#">Mario</a>
                  <a class="dropdown-item" href="#">Sonic</a>
                  <a class="dropdown-item" href="#">Zelda</a>
